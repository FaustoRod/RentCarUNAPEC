...
namespace RentCarUnapec.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<RentCarUser> signInManager, 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    UserInfo.Instance.SetEmployeeId(_userManager.Users.SingleOrDefault(x => x.UserName.Equals(Input.UserName)));
                ...
                {
                    ModelState.AddModelError(string.Empty, "Fallo Inicio de Sesion.");
                    return Page();
                }
            }
